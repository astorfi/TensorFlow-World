...
def MLP_L(X, dropout_param):
    ...
    CNN_output = CNN_Structure_L(X, dropout_param)
    ...
    y_f1 = fc_layer(CNN_output, num_outputs, activation_fn, dropout_param, name='fc_1_L')

    # Fully_Connected layer - 2
    num_outputs = 1024
    activation_fn = None
    y_f2 = fc_layer(y_f1, num_outputs, activation_fn, dropout_param, name='fc_2_L')

    # Fully_Connected layer - 2
    num_outputs = 174
    activation_fn = None
    y_f3 = fc_layer(y_f2, num_outputs, activation_fn, dropout_param, name='fc_3_L')

    return CNN_output, y_f3

def MLP_R(X, dropout_param):
    """This function create each branch os Siamese Architecture.
       Basically there are not two branches. They are the same!!
        ...
        """
    # Get the output features generated by CNN.
    CNN_output = CNN_Structure_R(X, dropout_param)
    ...
    num_outputs = 2048
    activation_fn = tf.nn.relu
    y_f1 = fc_layer(CNN_output, num_outputs, activation_fn, dropout_param, name='fc_1_R')

    # Fully_Connected layer - 2
    num_outputs = 1024
    activation_fn = None
    y_f2 = fc_layer(y_f1, num_outputs, activation_fn, dropout_param, name='fc_2_R')

    # Fully_Connected layer - 2
    num_outputs = 174
    activation_fn = None
    y_f3 = fc_layer(y_f2, num_outputs, activation_fn, dropout_param, name='fc_3_R')

    return CNN_output, y_f3


def CNN_Structure_L(x, dropout_param):
    ...
    relu11 = convolution_layer(x, kernel_size, NumFeatureMaps, activation, dropout_param, name='conv11_L')
    ...
    # Pool_1 layer
    pool_1 = max_pool(relu11, 2, 2, name='pool_1_L')
    ...
    kernel_size = [kernel_height, kernel_width]
    activation = tf.nn.relu
    relu21 = convolution_layer(pool_1, kernel_size, NumFeatureMaps, activation, dropout_param, name='conv21_L')
    ...
    # Pool_2 layer
    pool_2 = max_pool(relu21, 2, 2, name='pool_2_L')
    ...
    kernel_size = [kernel_height, kernel_width]
    activation = tf.nn.relu
    relu31 = convolution_layer(pool_2, kernel_size, NumFeatureMaps, activation, dropout_param, name='conv31_L')
...
def CNN_Structure_R(x, dropout_param):
    """This is the whole structure of the CNN.
    ...
    kernel_size = [kernel_height, kernel_width]
    activation = tf.nn.relu
    relu11 = convolution_layer(x, kernel_size, NumFeatureMaps, activation, dropout_param, name='conv11_R')
    ...
    # Pool_1 layer
    pool_1 = max_pool(relu11, 2, 2, name='pool_1_R')
    ...
    kernel_size = [kernel_height, kernel_width]
    activation = tf.nn.relu
    relu21 = convolution_layer(pool_1, kernel_size, NumFeatureMaps, activation, dropout_param, name='conv21_R')
    ...
    # Pool_2 layer
    pool_2 = max_pool(relu21, 2, 2, name='pool_2_R')
    ...
    kernel_size = [kernel_height, kernel_width]
    activation = tf.nn.relu
    relu31 = convolution_layer(pool_2, kernel_size, NumFeatureMaps, activation, dropout_param, name='conv31_R')
