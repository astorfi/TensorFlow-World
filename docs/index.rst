...
The tutorial are ready to used and the explanations are present in the `Link wiki <https://github.com/astorfi/Tensorflow-Turorials/wiki>`  associated with this repository.
